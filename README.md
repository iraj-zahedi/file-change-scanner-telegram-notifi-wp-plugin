...
این افزونه به شما کمک می‌کند تا تغییرات فایل‌ها را مانیتور کنید، اما امنیت واقعی یک وب‌سایت از یک زیرساخت میزبانی قدرتمند شروع می‌شود. برای دستیابی به حداکثر امنیت و عملکرد، توصیه می‌شود که سایت وردپرسی خود را در یک محیط ایزوله مانند یک [سرور مجازی امن و پرسرعت](https://blueserver.ir/vps) اجرا کنید. این کار از مشکلات رایج در هاست‌های اشتراکی جلوگیری کرده و به شما کنترل کاملی بر روی تنظیمات امنیتی سرورتان می‌دهد.

این افزونه توسط ایرج زاهدی و تیم [بلوسرور](https://blueserver.ir) توسعه داده شده است؛ جایی که ما در ارائه راهکارهای بهینه سرور مجازی برای وردپرس تخصص داریم.
